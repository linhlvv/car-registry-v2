...
name_p1 = ["David", "Vodka", "Vladimir", "Viktor", "Hữu",
           "Văn", "Hữu", "Thị", "Gia", "An", "Hoài",
           "Thanh", "Minh", "Ngọc", "Thuỳ", "Hồng",
           "Bảo", "Đức", "Quốc", "Thịnh", "Duy", "Trung",
           "Michael", "Emily", "William", "Elizabeth", "Alex",
           "Victoria", "James", "Johny", "Honey",
           "Alice", "Bob", "Charlie", "David", "Emma",
           "Frank", "Grace", "Harry", "Isabel", "Jack",
           "Kate", "Leo", "Mia", "Noah", "Olivia", "Peter",
           "Quinn", "Ruby", "Sam", "Tara", "Uma", "Victor",
           "Wendy", "Xavier", "Yara", "Zach", "Anna", "Ben",
           "Claire", "Daniel"]
name_p2 = ['Quang', 'Linh', 'Tuấn', 'Dũng', 'Vinh', 'Hiếu',
...
with io.open('backend/sql_generate/sql/account_centre.sql', 'w', encoding='utf-8') as f:
    f.write("\n".join(["insert into `account` (`email`, `password`, `type`) values ('" + email + "', '" + pw + "', '0');\n"
                       + "insert into `centre` (`id`, `name`,`city`,`district`,`activation`) values ((SELECT MAX(ID) FROM `account`), '" +
                       name + "', '" + province + "', '" +
                       district + "', '" + str(date) + "');"
