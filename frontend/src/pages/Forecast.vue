                        ...
                        <div class="flex items-center flex-col w-[90vw]">
                            <div class="flex justify-between items-center w-full">
                                ...
                                <div class="flex items-center space-x-6">
                                    <div class="flex items-center shadow-sm rounded-md overflow-hidden bg-white">
                                        <div @click="changeStatus('renew')" class="flex items-center p-3 cursor-pointer duration-300 ease-in-out transition-all relative overflow-hidden" :class="status === 'renew' ? 'bg-red-500 text-white w-28' : 'text-red-500 w-12'">
                                            ...
                                            <span :class="status === 'renew' ? '' : 'hidden'" class="font-semibold ml-9 text-sm absolute">Expired</span>
                                        </div>
                                        <div @click="changeStatus('new')" class="flex items-center p-3 cursor-pointer duration-300 ease-in-out relative overflow-hidden" :class="status === 'new' ? 'bg-[#93a3e6] text-white w-[85px]' : 'text-[#93a3e6] w-12'">
                                            <p :class="status === 'new' ? '' : 'hidden'" class="font-semibold text-sm absolute">New</p>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" :class="status === 'new' ? 'ml-9' : ''" >
