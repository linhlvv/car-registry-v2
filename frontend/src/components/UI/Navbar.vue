            ...
            <nav class="bg-white">
                <div class="max-w-screen-xl mx-auto">
                    <div class="flex items-center justify-between">
                        <button @click="moveSelection('left')" class="flex justify-center items-center cursor-pointer w-[10%] py-8 text-[#2acc97] duration-200 hover:text-white hover:bg-[#2acc97]/90 active:bg-[#2acc97]">
                        ...
                        <button @click="moveSelection('right')" class="flex justify-center items-center cursor-pointer w-[10%] py-8 text-[#2acc97] duration-200 hover:text-white hover:bg-[#2acc97]/90 active:bg-[#2acc97]">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
