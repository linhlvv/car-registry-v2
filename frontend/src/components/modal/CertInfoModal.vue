...
<template>
    <div class="w-full h-screen fixed z-50 flex items-center justify-center top-0">
        ...
        <div class="fade bg-[#f5f7fb] rounded-[8px] p-4 fixed w-3/5 max-2xl:max-w-3xl 2xl:max-w-4xl z-[60] flex flex-col modal-animation overflow-hidden h-fit">
            ...
            <div class="w-full flex items-center mb-2 max-md:flex-col-reverse">
                ...
                <div class="w-1/2 max-md:w-full flex flex-col max-md:flex-row items-center">
