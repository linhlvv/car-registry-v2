<script setup>
const props = defineProps(['car', 'carTypeSelection']);
...
<template>
    <div class="bg-white p-2 flex w-full mt-[2px]">
        ...
        <div v-if="carTypeSelection === 'registed'" class="w-[26%] flex items-center max-[736px]:hidden">
            ...
            <div class="max-[736px]:hidden font-bold text-[11px] max-[900px]:text-[10px] flex justify-center items-center w-1/2">
                <div v-if="car.valid">
                    <i class="fa-solid fa-check text-[#2acc97]"></i>
                </div>
                <div v-else>
                    <i class="fa-solid fa-xmark text-[#DC7270]"></i>
                </div>
            </div>
        </div>
        ...
        <div class="font-semibold text-[#616367] text-[11px] max-[900px]:text-[10px] flex text-right justify-end items-center w-[17%]">
            {{ car.owner }}
        </div>
        <div class="flex items-center w-[21%] justify-evenly max-[820px]:justify-center max-[820px]:gap-4">
