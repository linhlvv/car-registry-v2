...
<template>
    ...
    <div class="bg-white flex-col rounded-[8px] fixed top-[17vh] left-[20%] max-[560px]:left-[10%] w-3/5 max-[560px]:w-4/5 z-50 flex modal-animation overflow-hidden max-[560px]:flex-col max-[560px]:absolute">
